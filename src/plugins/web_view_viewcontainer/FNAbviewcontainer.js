// FNAbviewcontainer Properties
// A properties side import for an ABView.
//
var myClass = null;
export default function FNAbviewcontainerProperties({
   AB,
   ...
   if (!myClass) {
      ...
      let ABViewContainerDefaults = {};

      myClass = class ABAbviewcontainerProperties extends (
         ABViewPropertiesPlugin
      ) {
         static getPluginKey() {
            return this.key;
         ...
         constructor(base = "properties_abview_container", ids = {}) {
            ...
            ABViewContainerDefaults =
               this.AB.ClassManager.viewClass("viewcontainer").defaultValues();
         }
