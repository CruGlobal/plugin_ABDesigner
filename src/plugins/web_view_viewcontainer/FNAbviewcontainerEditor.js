...
//
export default function FNAbviewcontainerEditor({ AB, ABViewEditorPlugin }) {
   // const uiConfig = AB.Config.uiSettings();

   const L = AB.Label();

   return class ABViewContainerEditor extends ABViewEditorPlugin {
      static getPluginKey() {
         return this.key;
      }
      ...
      viewDelete(e, id /*, trg */) {
         ...
         webix.confirm({
            ...
            text: L("Do you want to delete <b>{0}</b>?", [deletedView.label]),
