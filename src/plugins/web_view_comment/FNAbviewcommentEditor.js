...
//
export default function FNAbviewcommentEditor({ AB, ABViewEditorPlugin }) {
   const BASE_ID = "interface_editor_viewcomment";

return class ABAbviewcommentEditor extends ABViewEditorPlugin {
